...
function getNewsletterDir(type: string): string {
  switch (type) {
    case 'ai-daily': return path.join(process.cwd(), 'content', 'newsletters', 'zh')
    case 'agentic': return path.join(process.cwd(), 'content', 'newsletters', 'ai-daily', 'zh')
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        {newsletters.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '64px 0' }}>
            <p style={{ color: '#6b7280', fontSize: '16px', marginBottom: '8px' }}>暂无简报</p>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ width: '56px', flexShrink: 0, textAlign: 'right' }}>
                    <div style={{ fontSize: '14px', fontWeight: '600', color: '#111827' }}>{month}{day}日</div>
                    <div style={{ fontSize: '12px', color: '#9ca3af' }}>{weekday}</div>
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <h2 style={{ fontSize: '15px', fontWeight: '500', color: '#111827', marginBottom: '4px', lineHeight: '1.5' }}>{entry.title}</h2>
                    {entry.preview && (
