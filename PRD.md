...
║       │ + 复用 research  │  │ Sonnet CLI      │                     ║
║       │ Sonnet CLI      │  │ $0 (Max Plan)   │                     ║
║       │ $0 (Max Plan)   │  │ 10-20篇/周      │                     ║
║       │ 3-5篇/周        │  │                 │                     ║
║       └────────┬───────┘  └──────┬─────────┘                     ║
║                │                 │                                ║
...
| **写作** | Claude Opus (CLI) | Claude Sonnet (CLI) | Claude Sonnet (CLI) |
| **成本** | $0 (Max Plan) | $0 (Max Plan) | $0 (Max Plan) |
...
│  ├─ 中英文各 5-10 个                                      │
│  └─ 模型: Claude Sonnet CLI ($0, Max Plan)                │
│                                                          │
│  来源 5: 📊 手动导入                                       │
...
> **模型已确定**：Tier 2/3、FAQ、Glossary 等内容生成统一使用 Claude Sonnet CLI（Max Plan 包含，边际成本 $0）。原 Gemini Flash 调用已全部迁移至 Sonnet CLI（2026-02-19）。
...
- [x] ~~A/B 测试: Gemini Flash vs Claude Sonnet~~ → 已统一使用 Sonnet CLI (2026-02-19)
